...
class UserPreference(Base):
    ...
    font_family = Column(String(64), nullable=False, default="dm_sans", server_default="dm_sans")
    font_size = Column(String(16), nullable=False, default="medium", server_default="medium")
